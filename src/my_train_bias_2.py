...
from OpenMatch.data.datasets.my_bert_dataset_bias_2 import BertDataset
from OpenMatch.data.datasets.my_roberta_dataset_bias_2 import RobertaDataset
from regularized_loss import bias_regularized_margin_ranking_loss_2
    ...
    for epoch in range(args.epoch):
        ...
        for step, train_batch in enumerate(tqdm(train_loader)):
            ...
            if args.task == 'ranking':
                ...
                batch_loss = bias_regularized_margin_ranking_loss_2(batch_score_pos.tanh(), batch_score_neg.tanh(),
                                                                  regularizer_pos=args.regularizer, bias_pos=train_batch["bias_pos"].to(device))
            elif args.task == 'classification':
