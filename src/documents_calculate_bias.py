...
collection_path = "./data/collection.tsv" #path to a preprocessed version of collection.tsv provided by MSMARCO collection
wordlist_path = "/home/amin/git_repos/GenderBias_IR/resources/wordlist_genderspecific_with_names.txt"

docs_bias_save_paths = {'tc':"./data/ARaB/amin_msmarco_passage_docs_bias_tc.pkl",
                        'bool':"./data/ARaB/amin_msmarco_passage_docs_bias_bool.pkl",
                        'tf':"./data/ARaB/amin_msmarco_passage_docs_bias_tf.pkl"}
